    	...
    	<div class="card text-cl-dark pt-3" v-show="showCardRegister">
    	  <div class="card-body">
    	    ...
    	    <form method="post" @submit.prevent="Register" class="mt-3">
    	      ...
    	      <div class="mb-3">
    	        <label :for="state.confirmPasswordRef.title" class="form-label text-capitalize">
    	          {{ state.confirmPasswordRef.title }}
    	        </label>
    	        
    	        <input 
    	           :type="state.confirmPasswordRef.type || state.confirmPasswordRef.title"
    	           class="form-control"
	...
	export default {
        ...
        document.documentElement.scrollTop = 0
			...
			const Register = () => {
			  ...
			  firebase
			    .auth()
			    .createUserWithEmailAndPassword(state.emailRef.value, state.passwordRef.value)
